...
public class KryoEncoderOld implements Encoder<Object> {
    ...
    private static com.nimrodtechs.rsock.serialization.KryoCommon kryoCommon;

    List<MimeType> mimeTypes = new ArrayList<>();

    public KryoEncoderOld(com.nimrodtechs.rsock.serialization.KryoCommon kryoCommon) {
    ...
    public DataBuffer encodeValue(Object value, DataBufferFactory bufferFactory, ResolvableType valueType, MimeType mimeType, Map<String, Object> hints) {
        ...
        com.nimrodtechs.rsock.serialization.KryoInfo kryoInfo = kryoCommon.getKryoThreadLocal().get();
